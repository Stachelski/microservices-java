...
public class CurrencyController {
    ...
    public CurrencyController(CurrencyRepository repository, Environment environment, ConcurrentMapCacheManager concurrentMapCacheManager, BCBClient bcbClient) {
